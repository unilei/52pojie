...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"53pj","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
var _jrscRequest = _interopRequireDefault(__webpack_require__(/*! ./jrscRequest.js */ 21));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // 今日诗词

// 
function getJrscToken(data) {
  return (0, _jrscRequest.default)({
    method: "GET",
    url: 'token',
    data: data });
...
{
  getJrscToken: getJrscToken,
  getSentence: getSentence };exports.default = _default;
...
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var request = function request(config) {
  ...
  config.url = 'https://v2.jinrishici.com/' + api_url;
  ...
  var xUserToken = uni.getStorageSync('jrscToken');
  if (xUserToken) {
    config.header = {
...
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var request = function request(config) {
  ...
  config.url = 'https://tenapi.cn/' + api_url;
